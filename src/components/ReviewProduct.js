  ...
  <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
    <div className="w-full">
          ...
          {[5, 4, 3, 2, 1].map((rating, index) => (
            <div key={index} className="flex items-center w-full">
              ...
              <p className={`h-2 w-full ${rating === 5 ? 'sm:min-w-[278px]' : 'xl:min-w-[278px]'} rounded-3xl bg-amber-50 ml-5 mr-3`}>
                <span className={`h-full w-[${[30, 40, 20, 16, 8][index]}%] rounded-3xl bg-amber-400 flex`}></span>
              </p>
              <p className="font-medium text-lg text-black mr-0.5">{[989, 4500, 50, 16, 8][index]}</p>
            </div>
          ))}
        </div>
      ...
      <div className="pt-11 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
        ...
        <h3 className="font-manrope font-semibold text-xl sm:text-2xl leading-9 text-black mb-6">Outstanding Experience!!!</h3>
      ...
      <div className="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
        ...
        <h3 className="font-manrope font-semibold text-xl sm:text-2xl leading-9 text-black mb-6">Pagedone's design system seamlessly bridges the gap between designers and developers!</h3>
        <div className="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
          <div className="flex items-center gap-3">
