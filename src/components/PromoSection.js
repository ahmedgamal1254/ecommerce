...
const PromoOffer = () => {
  return (
    <section className="bg-gray-50 px-6 py-12 md:py-16">
      <div className="mx-auto max-w-screen-xl rounded-xl bg-white p-8 shadow-xl lg:grid lg:grid-cols-12 lg:gap-8 lg:p-12 xl:gap-16">
        {/* 👕 صورة المنتج */}
        <div className="lg:col-span-5 flex items-center justify-center">
          <img
            className="h-56 w-56 sm:h-72 sm:w-72 md:h-80 md:w-80 lg:h-96 lg:w-96 rounded-lg shadow-lg object-cover"
        ...
        <div className="lg:col-span-7 mt-8 lg:mt-0 flex flex-col justify-center">
          ...
          <div className="flex justify-start items-center space-x-4">
            ...
            <Link
              href="/shop"
              className="inline-flex items-center justify-center rounded-lg border-2 border-blue-600 px-8 py-4 text-center text-lg font-semibold text-blue-600 hover:bg-blue-600 hover:text-white hover:shadow-lg transition duration-300 ease-in-out"
            >
              اعرف المزيد
            </Link>
          </div>
